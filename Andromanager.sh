...
[01;94mAndromananger [01;91m- [01;92mManage Android application in Linux (CLI)
[0m
USAGE :-
      Andromananger [options]
...
[0m
EOF
    echo -e "\t\t\t\e[93mMade with \e[91m❤️\e[93m by \e[1;92mASEKUN FATAI\e[0m\n"
...
function print_banner_main() {
    ...
    if [[ "$TERM_COLUMN" -ge "70" ]]; then
        ...
        echo -e "\n\e[1;93mWarning : \e[0mTerminal size is small.\n"
    fi
}
...
###### OPTION 3 "INSTALL AN APPLICATION" ######
